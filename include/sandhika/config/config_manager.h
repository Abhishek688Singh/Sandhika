...
#include "sandhika/config/config_types.h"
...
public:
    ...
    [[nodiscard]] MediaModeConfig getMediaModeConfig() const;
    void setMediaModeEnabled(bool enabled);
...
private:
    ...
    MediaModeConfig media_mode_config_;
